    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public async Task LoadData()
        {
            if (MovieItems.Count == 0)
            {
                ...
                // TODO 加入磁贴 正在热映
                Singleton<LiveTileService>.Instance.AddTileToQueue("最新上映", MovieItems[0].TitleCn, MovieItems[0].TitleEn, "想看人数", MovieItems[0].WantedCount.ToString(), MovieItems[0].Image);
            }
        }
